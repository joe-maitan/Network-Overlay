...
public class Registry extends Node {
    ...
    public Registry(int port_number) {
        /* Because Registry extends the Node class, we call the Node(PORT) constructor, which spawns
         * the TCPServerThread and runs that thread, which connects a server socket and looks for connections to that node
         */
        super(port_number);
